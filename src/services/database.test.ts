...
export function startMockDB() {
    ...
    vi.spyOn(DB, "insertBookmark").mockImplementation(
        async (title: string, url: string, desc: string, tags: string[]) => {
     ...
     * テストするならそっちで書いて
     */
    vi.spyOn(DB, "fuzzyFindTag").mockImplementation(
    ...
    vi.spyOn(DB, "fetchBookmarks").mockImplementation(
    ...
    vi.spyOn(DB, "editTag").mockImplementation(
    ...
    vi.spyOn(DB, "editBookmark").mockImplementation(
        async (
            id: number,
            title: string,
            url: string,
...
const testBookmarks: Bookmark[] = [
    ...
    },
    {
        ...
        desc: "d",
        url: "url",
        tags: ["cpp", "kotlin", "javascript", "less", "html"],
        created_at: "2025-02-07",
    },
    {
        id: 5,
        ...
        desc: "d",
        url: "url",
        tags: ["scala", "perl", "java", "json", "csharp"],
        created_at: null,
    },
    {
        id: 6,
    ...
    },
    {
        ...
        desc: "d",
        url: "url",
        tags: ["cpp", "css", "javascript", "rust", "json"],
        created_at: "2025-02-07",
    },
    {
        id: 8,
        ...
        desc: "d",
        url: "url",
        tags: ["typescript", "clang", "haskell", "html"],
        created_at: null,
    },
    {
        id: 9,
    ...
    },
    {
        ...
        desc: "d",
        url: "url",
        tags: ["ruby", "typescript", "haskell", "json", "sql"],
        created_at: "2025-02-07",
    },
    {
        id: 13,
    ...
    },
    {
        ...
        desc: "d",
        url: "url",
        tags: ["kotlin", "haskell", "ruby", "typescript", "ruby"],
        created_at: "2025-02-07",
    },
    {
        id: 15,
    ...
    },
    {
        ...
        desc: "d",
        url: "url",
        tags: ["php", "sql", "python", "typescript"],
        created_at: "2025-02-07",
    },
    {
        id: 19,
